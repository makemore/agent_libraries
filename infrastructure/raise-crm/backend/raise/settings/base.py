"""
Django settings for raise project.
...
from .engagement import configure_engagement
...
WSGI_APPLICATION = 'raise.wsgi.application'
...
# Contact-only deployments omit the event store; event access still fails closed.
DATABASES = configure_engagement(DATABASES, os.getenv('ENGAGEMENT_DATABASE_URL'))
