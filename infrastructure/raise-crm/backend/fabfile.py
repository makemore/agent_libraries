"""
Raise CRM - Fabric Deployment & GCP Setup Tasks
...
GCP_PROJECT_ID = os.getenv("GCP_PROJECT_ID", "raise")
GCP_REGION = os.getenv("GCP_REGION", "europe-west2")
CLOUD_SQL_INSTANCE = os.getenv("CLOUD_SQL_INSTANCE", "kryten")
CLOUD_SQL_PROJECT = os.getenv("CLOUD_SQL_PROJECT", "crimson-305210")
SERVICE_NAME = os.getenv("SERVICE_NAME", "raise")
